...
public class ParametersInitial {
  ...
  public static final String teamAMainBotBrainClassName = "algorithms.Stage1_mieux"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.Stage1_mieux"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.Stage1_mieux"; //class given by name; is supposed to extends robotsimulator.Brain
